...
Path destinationFolder = Paths.get("C:\\Users\\Quixel\\Documents\\Asset Tracker Downloads\\${GlobalVariable.AssetID}\\rc-${GlobalVariable.AssetID}")
...
Path destinationFolder1 = Paths.get("C:\\Users\\Quixel\\Documents\\Asset Tracker Downloads\\" + GlobalVariable.AssetID + "\\previz-" + GlobalVariable.AssetID + "\\rc-proj-" + GlobalVariable.AssetID)
